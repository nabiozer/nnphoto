...
import { createPhoto, deletePhoto, getPhotoById, getPhotosPagination, getPhotosWithUrl, updatePhoto } from '../controllers/photoControllers.js';
import { admin, protect } from '../middleware/authMiddleware.js';
const router = express.Router();



router.route('/').get(getPhotosPagination).post(protect,admin,createPhoto)
