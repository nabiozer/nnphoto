...
export { default as Player } from './components/Display/Player';
...
export { default as TabItem } from './components/Display/Tab2/TabItem';
export { default as TabMenu } from './components/Display/Tab2/TabMenu';
